...
file_path = 'required_tickers.txt'

for i in range(0, len(tickers)):
    actual_vector.append(yf.download(tickers[i], '2024-08-23', '2024-08-24')['Close'][0])
...
def train_ensemble_model(data_split,name):
    ...
    if (combined_pred.mean() - actual_vector[name])/actual_vector[name] > 0.05:
